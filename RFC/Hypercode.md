...
* `hypercode diff` (HC-113) shipped: hash-driven affected-node set between two resolved documents, with old/new winning rules; `hypercode.diff/v1` output format (§9.7).
