...
([Backends.md](Backends.md)), а HCS property contracts уже накапливаются по
пересечению и только сужаются ([Usage.md](Usage.md#2-guardrails-contracts-as-a-ci-gate)).
...
[Codegen demo](../Examples/codegen-demo/README.md) уже иллюстрирует генерацию и
